    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanApproveAnyLeave,
                ...
                localizer["Allows approving or rejecting any leave application, regardless of the reporting line, and viewing any user's leave history."]),
            ...
            new(AppPermissionNames.CanPrintSelfCertificates,
                localizer["Print Self Certificates"],
                localizer["Allows printing employment and income certificates for oneself."]),
            ...
            new(AppPermissionNames.CanManageCustomerRelationships,
                localizer["Manage Customer Relationships"],
                localizer["Allows creating, updating, and deleting customer relationship information. Every user can view customer relationships by default."]),
            new(AppPermissionNames.CanManageMarketChannels,
                localizer["Manage Market Channels"],
                localizer["Allows creating, updating, and deleting market channel information. Every user can view market channels by default."]),
            ...
            new(AppPermissionNames.CanViewCollectionChannels,
                localizer["View Collection Channels"],
                localizer["Allows viewing the list of all collection channels and their records."]),
            new(AppPermissionNames.CanManageCollectionChannels,
                localizer["Manage Collection Channels"],
                localizer["Allows creating, updating, and deleting collection channels and their records."]),
            ...
            new(AppPermissionNames.CanManageServices,
                localizer["Manage Services"],
                localizer["Allows creating, updating, and deleting services and DNS providers. Every user can view services by default."]),
