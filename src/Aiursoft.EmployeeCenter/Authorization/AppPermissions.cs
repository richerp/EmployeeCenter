...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanCreateWeeklyReportForAnyone,
                localizer["Create Weekly Report for Anyone"],
                localizer["Allows the user to create weekly reports on behalf of any other user."]),
