    ...
    SignInManager<User> signInManager) : IScopedDependency
{
    ...
    private void _useless_for_localizer()
    {
        ...
        _ = localizer["Entities List"];
        _ = localizer["Create New"];
        _ = localizer["Company Name"];
        _ = localizer["Code"];
        _ = localizer["Legal Rep"];
        _ = localizer["Address"];
        _ = localizer["Actions"];
        _ = localizer["Details"];
        _ = localizer["Confirm Delete"];
        _ = localizer["Entity Details"];
        _ = localizer["Additional Info (Mainland/HK)"];
        _ = localizer["Save Changes"];
        _ = localizer["Basic Information"];
        _ = localizer["English Name"];
        _ = localizer["Entity Code"];
        _ = localizer["CI Number"];
        _ = localizer["Legal Rep / Director"];
        _ = localizer["Bank Info"];
        _ = localizer["Images & Files"];
        _ = localizer["Logo"];
        _ = localizer["Official Seal"];
        _ = localizer["Business License"];
        _ = localizer["Download / View"];
        _ = localizer["Restricted"];
        _ = localizer["Administrative Details"];
        _ = localizer["Company Type"];
        _ = localizer["Establishment"];
        _ = localizer["Expiry Date"];
        _ = localizer["Reg Capital"];
        _ = localizer["Status"];
        _ = localizer["SCR Location"];
        _ = localizer["Secretary"];
