...
app_name="employeeCenter"
repo_path="https://gitlab.aiursoft.com/aiursoft/employeeCenter"
proj_path="src/Aiursoft.EmployeeCenter/Aiursoft.EmployeeCenter.csproj"
